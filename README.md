...
2. Review MAC addresses and vendor names for each host.
...
- Vendor lookup downloads the IEEE OUI database on first scan and caches it in `~/.cache/network-scanner/oui.csv`.
